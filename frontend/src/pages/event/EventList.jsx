    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="text-center mb-12">
                ...
                <p className="mt-4 text-xl text-gray-500 dark:text-gray-400">Join our community events and make a difference.</p>
            </div>
            ...
            {loading ? (
                ...
                <div className="text-center text-gray-500 dark:text-gray-400 py-12">No upcoming events at the moment.</div>
            ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {events.map(event => (
                        <div key={event.id} className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden flex flex-col transition-transform hover:-translate-y-1">
