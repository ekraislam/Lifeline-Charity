    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="sm:flex sm:items-center sm:justify-between mb-8">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Manage All Events</h1>
                    <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">View, edit, and delete all events across the platform.</p>
                </div>
            ...
            {loading ? (
                ...
                <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100">
                    <p className="text-gray-500 dark:text-gray-400 mb-4">No events found in the system.</p>
